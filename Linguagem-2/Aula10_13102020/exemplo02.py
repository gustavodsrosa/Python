...
class Aluno(Pessoa):
    def __init__(self, nome, email, telefone, ra, turma):
        super().__init__(nome, email, telefone)  # chama construtor da classe mãe
        self.ra = ra
        self.turma = turma
...
class Professor(Pessoa):
    def __init__(self, nome, email, telefone, salario):
        super().__init__(nome, email, telefone)     # chama o construtor da classe mãe
...
# Criação da Class Diretor
class Diretor(Pessoa):
    def __init__(self, nome, email, telefone, idade, ano_entrada):
    ...
    def exibir_dados(self):
        ...
        print('Entrada:', self.ano_entrada)
...
pessoa1 = Pessoa("Maria", "maria@maria.com", "11989999977")
pessoa1.exibir_dados()

diretor = Diretor('Márcio', "marciorib@gmail.com", '1122222222', 59, 1993)
diretor.exibir_dados()